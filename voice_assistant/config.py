...
class Settings:
    ...
    llm_backoff_seconds: float = float(os.getenv("LLM_BACKOFF_SECONDS", "1.5"))
    ...
    memory_message_limit: int = int(os.getenv("MEMORY_MESSAGE_LIMIT", "12"))
    ai_log_file: str = os.getenv("AI_LOG_FILE", ".data/ai_responses.log")
